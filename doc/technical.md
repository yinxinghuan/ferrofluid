...
- 游戏：Ferrofluid
- 类型：casual
- 简述：A magnet in your finger. Drag the pool and watch the black metal pull into spikes, chasing your touch. Pure sensory toy — no scoring, no winning, just shiny. AlterU sensory series.
- 框架 / 语言 / 构建：JavaScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Ferrofluid；cover_url=/poster.png；category=casual；uuid=838a1123-25a5-4c54-a065-32b236f039d7
